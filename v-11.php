...
// -----------------------------
// Display shipping zone with "write select shipping location" text
// -----------------------------
add_action('woocommerce_review_order_after_order_total', function () {
    ...
    <tr class="wc-city-zones-display">
        ...
        <td data-title="<?php echo esc_attr("Select Shipping Zone"); ?>">
            <div id="wc-city-zones-selector">
                ...
                ?>
                    <label style="display:inline-block;margin-right:20px;margin-bottom:5px;cursor:pointer;">
                        <input type="radio" 
                               name="wc_city_zone" 
...
add_action('wp_footer', function () {
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            // Trigger checkout update when radio changes (NO label text change)
